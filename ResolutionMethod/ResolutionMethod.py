...
def resolution_solver(KB, neg_alpha):
    ...
    while todo:
        ...
        for clause in done + todo:
            if isSubset(current, clause) and clause != clause:
                skip = True
                break
            else:
                skip = False
...
if __name__ == '__main__':
    ...
    test = [['-p', 'q'], ['-l', '-m', 'p'], ['-b', '-l', 'm'], ['-a', '-p', 'l'], ['-a', '-b', 'l'], ['a'], ['b']]
    print(simple_resolution_solver([['d'], ['-d']], ['a']))
    print(simple_resolution_solver(test, ['-q']))
    print(isSubset(['p', 'q'], ['q']))
